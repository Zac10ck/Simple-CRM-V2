	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["_userid"] <> "") {
				...
				$sReturnUrl = "clientlist.php"; // Return to list
			}
...
<?php if ($client->_userid->Visible) { // userid ?>
	<tr id="r__userid">
		<td class="col-sm-2"><span id="elh_client__userid"><?php echo $client->_userid->FldCaption() ?></span></td>
...
<?php echo $client->_userid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->date->Visible) { // date ?>
	<tr id="r_date">
		<td class="col-sm-2"><span id="elh_client_date"><?php echo $client->date->FldCaption() ?></span></td>
		<td data-name="date"<?php echo $client->date->CellAttributes() ?>>
<span id="el_client_date">
<span<?php echo $client->date->ViewAttributes() ?>>
<?php echo $client->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->client->Visible) { // client ?>
	<tr id="r_client">
		<td class="col-sm-2"><span id="elh_client_client"><?php echo $client->client->FldCaption() ?></span></td>
...
<?php echo $client->client->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->person->Visible) { // person ?>
	<tr id="r_person">
		<td class="col-sm-2"><span id="elh_client_person"><?php echo $client->person->FldCaption() ?></span></td>
...
<?php echo $client->person->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->desig->Visible) { // desig ?>
	<tr id="r_desig">
		<td class="col-sm-2"><span id="elh_client_desig"><?php echo $client->desig->FldCaption() ?></span></td>
		<td data-name="desig"<?php echo $client->desig->CellAttributes() ?>>
<span id="el_client_desig">
<span<?php echo $client->desig->ViewAttributes() ?>>
<?php echo $client->desig->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td class="col-sm-2"><span id="elh_client_phone"><?php echo $client->phone->FldCaption() ?></span></td>
		<td data-name="phone"<?php echo $client->phone->CellAttributes() ?>>
<span id="el_client_phone">
<span<?php echo $client->phone->ViewAttributes() ?>>
<?php echo $client->phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->_email->Visible) { // email ?>
	<tr id="r__email">
		<td class="col-sm-2"><span id="elh_client__email"><?php echo $client->_email->FldCaption() ?></span></td>
...
<?php echo $client->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->activity->Visible) { // activity ?>
	<tr id="r_activity">
		<td class="col-sm-2"><span id="elh_client_activity"><?php echo $client->activity->FldCaption() ?></span></td>
...
<?php echo $client->activity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->remark->Visible) { // remark ?>
	<tr id="r_remark">
		<td class="col-sm-2"><span id="elh_client_remark"><?php echo $client->remark->FldCaption() ?></span></td>
...
<?php echo $client->remark->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->followup->Visible) { // followup ?>
	<tr id="r_followup">
		<td class="col-sm-2"><span id="elh_client_followup"><?php echo $client->followup->FldCaption() ?></span></td>
...
<?php echo $client->followup->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->lat->Visible) { // lat ?>
	<tr id="r_lat">
		<td class="col-sm-2"><span id="elh_client_lat"><?php echo $client->lat->FldCaption() ?></span></td>
		<td data-name="lat"<?php echo $client->lat->CellAttributes() ?>>
<span id="el_client_lat">
<span<?php echo $client->lat->ViewAttributes() ?>>
<?php echo $client->lat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client->lng->Visible) { // lng ?>
	<tr id="r_lng">
		<td class="col-sm-2"><span id="elh_client_lng"><?php echo $client->lng->FldCaption() ?></span></td>
		<td data-name="lng"<?php echo $client->lng->CellAttributes() ?>>
<span id="el_client_lng">
<span<?php echo $client->lng->ViewAttributes() ?>>
<?php echo $client->lng->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
