...
$dar_view = NULL; // Initialize page object first

class cdar_view extends cdar {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["_userid"] <> "") {
				...
				$sReturnUrl = "darlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "darlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "darlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_dar\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_dar',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fdarview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($dar_view)) $dar_view = new cdar_view();
...
var CurrentForm = fdarview = new ew_Form("fdarview", "view");

// Form_CustomValidate event
fdarview.Form_CustomValidate = 
...
fdarview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($dar->Export == "") { ?>
<div class="ewToolbar">
<?php $dar_view->ExportOptions->Render("body") ?>
<?php
	foreach ($dar_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $dar_view->ShowPageHeader(); ?>
<?php
$dar_view->ShowMessage();
?>
<form name="fdarview" id="fdarview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($dar_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $dar_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="dar">
<input type="hidden" name="modal" value="<?php echo intval($dar_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($dar->_userid->Visible) { // userid ?>
	<tr id="r__userid">
		<td class="col-sm-2"><span id="elh_dar__userid"><?php echo $dar->_userid->FldCaption() ?></span></td>
		<td data-name="_userid"<?php echo $dar->_userid->CellAttributes() ?>>
<span id="el_dar__userid">
<span<?php echo $dar->_userid->ViewAttributes() ?>>
<?php echo $dar->_userid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($dar->date->Visible) { // date ?>
	<tr id="r_date">
		<td class="col-sm-2"><span id="elh_dar_date"><?php echo $dar->date->FldCaption() ?></span></td>
		<td data-name="date"<?php echo $dar->date->CellAttributes() ?>>
<span id="el_dar_date">
<span<?php echo $dar->date->ViewAttributes() ?>>
<?php echo $dar->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($dar->desig->Visible) { // desig ?>
	<tr id="r_desig">
		<td class="col-sm-2"><span id="elh_dar_desig"><?php echo $dar->desig->FldCaption() ?></span></td>
		<td data-name="desig"<?php echo $dar->desig->CellAttributes() ?>>
<span id="el_dar_desig">
<span<?php echo $dar->desig->ViewAttributes() ?>>
<?php echo $dar->desig->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($dar->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td class="col-sm-2"><span id="elh_dar_phone"><?php echo $dar->phone->FldCaption() ?></span></td>
		<td data-name="phone"<?php echo $dar->phone->CellAttributes() ?>>
<span id="el_dar_phone">
<span<?php echo $dar->phone->ViewAttributes() ?>>
<?php echo $dar->phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($dar->activity->Visible) { // activity ?>
	<tr id="r_activity">
		<td class="col-sm-2"><span id="elh_dar_activity"><?php echo $dar->activity->FldCaption() ?></span></td>
...
<?php echo $dar->activity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($dar->req->Visible) { // req ?>
	<tr id="r_req">
		<td class="col-sm-2"><span id="elh_dar_req"><?php echo $dar->req->FldCaption() ?></span></td>
		<td data-name="req"<?php echo $dar->req->CellAttributes() ?>>
<span id="el_dar_req">
<span<?php echo $dar->req->ViewAttributes() ?>>
<?php echo $dar->req->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($dar->followup->Visible) { // followup ?>
	<tr id="r_followup">
		<td class="col-sm-2"><span id="elh_dar_followup"><?php echo $dar->followup->FldCaption() ?></span></td>
...
<?php echo $dar->followup->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
