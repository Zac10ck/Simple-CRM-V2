...
//
// Table class for dar_view_comp
//
class cdar_view_comp extends cTable {
	var $date;
	var $client;
	var $person;
	var $desig;
	...
	function __construct() {
		...
		$this->TableVar = 'dar_view_comp';
		$this->TableName = 'dar_view_comp';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`dar_view_comp`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// date
		$this->date = new cField('dar_view_comp', 'dar_view_comp', 'x_date', 'date', '`date`', ew_CastDateFieldForLike('`date`', 0, "DB"), 133, 0, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// client
		$this->client = new cField('dar_view_comp', 'dar_view_comp', 'x_client', 'client', '`client`', '`client`', 200, -1, FALSE, '`client`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->client->Sortable = TRUE; // Allow sort
		$this->fields['client'] = &$this->client;

		// person
		$this->person = new cField('dar_view_comp', 'dar_view_comp', 'x_person', 'person', '`person`', '`person`', 200, -1, FALSE, '`person`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->person->Sortable = TRUE; // Allow sort
		$this->fields['person'] = &$this->person;

		// desig
		$this->desig = new cField('dar_view_comp', 'dar_view_comp', 'x_desig', 'desig', '`desig`', '`desig`', 200, -1, FALSE, '`desig`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->desig->Sortable = TRUE; // Allow sort
		$this->fields['desig'] = &$this->desig;

		// phone
		$this->phone = new cField('dar_view_comp', 'dar_view_comp', 'x_phone', 'phone', '`phone`', '`phone`', 131, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->phone->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['phone'] = &$this->phone;

		// email
		$this->_email = new cField('dar_view_comp', 'dar_view_comp', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// activity
		$this->activity = new cField('dar_view_comp', 'dar_view_comp', 'x_activity', 'activity', '`activity`', '`activity`', 200, -1, FALSE, '`activity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->activity->Sortable = TRUE; // Allow sort
		$this->fields['activity'] = &$this->activity;

		// req
		$this->req = new cField('dar_view_comp', 'dar_view_comp', 'x_req', 'req', '`req`', '`req`', 200, -1, FALSE, '`req`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->req->Sortable = TRUE; // Allow sort
		$this->fields['req'] = &$this->req;

		// followup
		$this->followup = new cField('dar_view_comp', 'dar_view_comp', 'x_followup', 'followup', '`followup`', '`followup`', 200, -1, FALSE, '`followup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->followup->Sortable = TRUE; // Allow sort
		$this->fields['followup'] = &$this->followup;

		// remark
		$this->remark = new cField('dar_view_comp', 'dar_view_comp', 'x_remark', 'remark', '`remark`', '`remark`', 200, -1, FALSE, '`remark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`dar_view_comp`";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "dar_view_compview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "dar_view_compedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "dar_view_compadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("dar_view_compview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("dar_view_compview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "dar_view_compadd.php?" . $this->UrlParm($parm);
		else
			$url = "dar_view_compadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("dar_view_compedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("dar_view_compadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("dar_view_compdelete.php", $this->UrlParm());
	}
