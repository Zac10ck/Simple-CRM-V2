...
//
// Table class for dar_act_req
//
class cdar_act_req extends cTable {
	var $date;
	var $client;
	var $person;
	var $activity;
	...
	function __construct() {
		...
		$this->TableVar = 'dar_act_req';
		$this->TableName = 'dar_act_req';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`dar_act_req`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// date
		$this->date = new cField('dar_act_req', 'dar_act_req', 'x_date', 'date', '`date`', ew_CastDateFieldForLike('`date`', 0, "DB"), 133, 0, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// client
		$this->client = new cField('dar_act_req', 'dar_act_req', 'x_client', 'client', '`client`', '`client`', 200, -1, FALSE, '`client`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->client->Sortable = TRUE; // Allow sort
		$this->fields['client'] = &$this->client;

		// person
		$this->person = new cField('dar_act_req', 'dar_act_req', 'x_person', 'person', '`person`', '`person`', 200, -1, FALSE, '`person`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->person->Sortable = TRUE; // Allow sort
		$this->fields['person'] = &$this->person;

		// activity
		$this->activity = new cField('dar_act_req', 'dar_act_req', 'x_activity', 'activity', '`activity`', '`activity`', 200, -1, FALSE, '`activity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->activity->Sortable = TRUE; // Allow sort
		$this->fields['activity'] = &$this->activity;

		// req
		$this->req = new cField('dar_act_req', 'dar_act_req', 'x_req', 'req', '`req`', '`req`', 200, -1, FALSE, '`req`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`dar_act_req`";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "dar_act_reqview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "dar_act_reqedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "dar_act_reqadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("dar_act_reqview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("dar_act_reqview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "dar_act_reqadd.php?" . $this->UrlParm($parm);
		else
			$url = "dar_act_reqadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("dar_act_reqedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("dar_act_reqadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("dar_act_reqdelete.php", $this->UrlParm());
	}
