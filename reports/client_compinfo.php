...
//
// Table class for client_comp
//
class cclient_comp extends cTable {
	var $client;
	var $person;
	var $desig;
	var $phone;
	...
	function __construct() {
		...
		$this->TableVar = 'client_comp';
		$this->TableName = 'client_comp';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`client_comp`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// client
		$this->client = new cField('client_comp', 'client_comp', 'x_client', 'client', '`client`', '`client`', 200, -1, FALSE, '`client`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->client->Sortable = TRUE; // Allow sort
		$this->fields['client'] = &$this->client;

		// person
		$this->person = new cField('client_comp', 'client_comp', 'x_person', 'person', '`person`', '`person`', 200, -1, FALSE, '`person`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->person->Sortable = TRUE; // Allow sort
		$this->fields['person'] = &$this->person;

		// desig
		$this->desig = new cField('client_comp', 'client_comp', 'x_desig', 'desig', '`desig`', '`desig`', 200, -1, FALSE, '`desig`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->desig->Sortable = TRUE; // Allow sort
		$this->fields['desig'] = &$this->desig;

		// phone
		$this->phone = new cField('client_comp', 'client_comp', 'x_phone', 'phone', '`phone`', '`phone`', 131, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->phone->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['phone'] = &$this->phone;

		// email
		$this->_email = new cField('client_comp', 'client_comp', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// date
		$this->date = new cField('client_comp', 'client_comp', 'x_date', 'date', '`date`', ew_CastDateFieldForLike('`date`', 0, "DB"), 133, 0, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// activity
		$this->activity = new cField('client_comp', 'client_comp', 'x_activity', 'activity', '`activity`', '`activity`', 200, -1, FALSE, '`activity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->activity->Sortable = TRUE; // Allow sort
		$this->fields['activity'] = &$this->activity;

		// remark
		$this->remark = new cField('client_comp', 'client_comp', 'x_remark', 'remark', '`remark`', '`remark`', 200, -1, FALSE, '`remark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->remark->Sortable = TRUE; // Allow sort
		$this->fields['remark'] = &$this->remark;

		// followup
		$this->followup = new cField('client_comp', 'client_comp', 'x_followup', 'followup', '`followup`', '`followup`', 200, -1, FALSE, '`followup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`client_comp`";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "client_compview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "client_compedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "client_compadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("client_compview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("client_compview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "client_compadd.php?" . $this->UrlParm($parm);
		else
			$url = "client_compadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("client_compedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("client_compadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("client_compdelete.php", $this->UrlParm());
	}
