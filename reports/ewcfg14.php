...
define("EW_PROJECT_ID", "{3FC7CB86-1F85-46A6-9781-36E2788B8DB5}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'smQiW5uU5gQksXaM', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sample", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "unisis123", TRUE); // Administrator password
