...
class cclient extends cTable {
	...
	function __construct() {
		...
		// userid
		$this->_userid = new cField('client', 'client', 'x__userid', 'userid', '`userid`', '`userid`', 3, -1, FALSE, '`userid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->_userid->Sortable = TRUE; // Allow sort
		$this->_userid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['userid'] = &$this->_userid;

		// date
		$this->date = new cField('client', 'client', 'x_date', 'date', '`date`', ew_CastDateFieldForLike('`date`', 0, "DB"), 133, 0, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// client
		$this->client = new cField('client', 'client', 'x_client', 'client', '`client`', '`client`', 200, -1, FALSE, '`client`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->client->Sortable = TRUE; // Allow sort
		$this->fields['client'] = &$this->client;

		// person
		$this->person = new cField('client', 'client', 'x_person', 'person', '`person`', '`person`', 200, -1, FALSE, '`person`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->person->Sortable = TRUE; // Allow sort
		$this->fields['person'] = &$this->person;

		// desig
		$this->desig = new cField('client', 'client', 'x_desig', 'desig', '`desig`', '`desig`', 200, -1, FALSE, '`desig`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->desig->Sortable = TRUE; // Allow sort
		$this->fields['desig'] = &$this->desig;

		// phone
		$this->phone = new cField('client', 'client', 'x_phone', 'phone', '`phone`', '`phone`', 131, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->phone->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['phone'] = &$this->phone;

		// email
		$this->_email = new cField('client', 'client', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// activity
		$this->activity = new cField('client', 'client', 'x_activity', 'activity', '`activity`', '`activity`', 200, -1, FALSE, '`activity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->activity->Sortable = TRUE; // Allow sort
		$this->fields['activity'] = &$this->activity;

		// remark
		$this->remark = new cField('client', 'client', 'x_remark', 'remark', '`remark`', '`remark`', 200, -1, FALSE, '`remark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->remark->Sortable = TRUE; // Allow sort
		$this->fields['remark'] = &$this->remark;

		// followup
		$this->followup = new cField('client', 'client', 'x_followup', 'followup', '`followup`', '`followup`', 200, -1, FALSE, '`followup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->followup->Sortable = TRUE; // Allow sort
		$this->fields['followup'] = &$this->followup;

		// lat
		$this->lat = new cField('client', 'client', 'x_lat', 'lat', '`lat`', '`lat`', 200, -1, FALSE, '`lat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lat->Sortable = TRUE; // Allow sort
		$this->fields['lat'] = &$this->lat;

		// lng
		$this->lng = new cField('client', 'client', 'x_lng', 'lng', '`lng`', '`lng`', 200, -1, FALSE, '`lng`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lng->Sortable = TRUE; // Allow sort
